...
<form action="admin/nuevo-editar" method="post" class="needs-validation p-5" novalidate>
<h2>Nuevo Libro / Editar Libro</h2>
  <div class="form-row">
  ...
  <div class="form-row">
    <div class="form-group col-lg-6 col-md-6 col-sm-6" >
      ...
      <div class="input-group mb-2">
        <input type="number" step=".01" class="form-control" id="precio" name="precio" placeholder="precio" min=0 value="${libro.precio}" >
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-6" >
      ...
      <div class="input-group mb-2">
        <input type="number" class="form-control" id="descuento" name="descuento" placeholder="descuento" min=0 max= 100 required value="${libro.descuento}" >
        <div class="input-group-prepend">
          <div class="input-group-text">%</div>
        </div>
